...
from faceswap.util import util
...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--load_pretrain",
            type=str,
            default="./checkpoints/simswap224_test",
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=200,
            help="frequence for printing log information",
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=10000,
            help="frequence for saving the model",
        )
...
if __name__ == "__main__":
    ...
    print(
        "Start to train at %s" % (datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    )
    ...
    for step in range(start, total_step):
        ...
        for interval in range(2):
            ...
            if interval:
                ...
                if step % 2 == 0:
                    # G_Rec
                    loss_G_Rec = (
                        model.criterionRec(img_fake, src_image1) * opt.lambda_rec
                    )
                    loss_G += loss_G_Rec
        ...
        if (step + 1) % opt.sample_freq == 0:
            ...
            with torch.no_grad():
                ...
                plot_batch(
                    imgs, os.path.join(sample_path, "step_" + str(step + 1) + ".jpg")
                )
